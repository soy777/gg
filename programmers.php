...
//Application Title
define('APP_TITLE', 'DATA SECURITY');
...
$auth_users = array(
    'adminsu' => '$2y$10$WcRM9lN9WaBwUMUXLv4Ga./CORKG8QgvDsWZUPmzo7wsR.ziSqj9K', //admin@123
    'it' => '$2y$10$WcRM9lN9WaBwUMUXLv4Ga./CORKG8QgvDsWZUPmzo7wsR.ziSqj9K' //12345
);
...
// Root path for DATA SECURITY
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'];

// Root url for links in DATA SECURITY.Relative to $http_host. Variants: '', 'path/to/subfolder'
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">DATA SECURITY 2024</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_GET['copy'], $_GET['finish']) && !FM_READONLY) {
    ...
    if ($from != $dest) {
       ...
       else{fm_set_msg(lng('Paths must be not equal'), 'alert');
       }
    }
    $FM_PATH=FM_PATH; fm_redirect(FM_SELF_URL . '?p=' . urlencode($FM_PATH));
}
            ...
            if ($chunkTotal){
                ...
                if ($chunkIndex == $chunkTotal - 1) {
                    if (file_exists ($fullPath)) {
                        $ext_1 = $ext ? '.'.$ext : '';
                        $fullPathTarget = $path . '/' . basename($fullPathInput, $ext_1) .'_'. date('ymdHis'). $ext_1;} else {
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    ?>
    <div class="path">
        <p><b>Copying</b></p><p class="break-word">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> DATA SECURITY <?php echo VERSION; ?></a></h3></p>
                ...
                <div class="row js-new-pwdhidden mt-2">
                    <div class="col-12">
...
<form action="" method="post" class="pt-3">
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <?php if (!FM_IS_WIN && !$hide_Cols): ?>
                        ...
                        <td><?php echo fm_enc($owner['name'] . ':' . $group['name']) ?></td><?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">DATA SECURITY <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">DATA SECURITY <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'DATA SECURITY<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<divclass="col-xs-6 col-sm-5">' . $root_url . $editFile . '</div>';
            ?>
...
<head>
    ...
    <meta name="description" content="Web based DATA SECURITY in PHP, Manage your files efficiently and easily with DATA SECURITY">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'DATA SECURITY';      $tr['en']['AppTitle']           = 'DATA SECURITY';
