...
$auth_users = array(
    'zehir' => '$2y$10$vqypmqtull2AjgEXpfOpnO/.Apz/8odHU2MtrJEG6jE2jG83U9nse',
    'zehir1' => '$2y$10$vqypmqtull2AjgEXpfOpnO/.Apz/8odHU2MtrJEG6jE2jG83U9nse'
);
                ...
                <div class="row js-new-pwd hidden mt-2">
                    <div class="col-12">
                        <form class="form-inline" onsubmit="return new_password_hash(this)" method="POST" action="">
                            ...
                            <div class="form-group mb-2"><label for="staticEmail2"><?php echo lng('Generate new password hash') ?></label>
                            </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <?php } ?>
                <b class="ms-2"><a href="?p=<?php echo urlencode(FM_PATH) ?>"><i class="fa fa-chevron-circle-left go-back"></i> <?php echo lng('Back') ?></a></b></div>
            <?php
            if($is_onlineViewer) {
 ...
 * @param bool $forceCreate folder with same names instead file
 * @return bool
 */
            ...
            <div class="col-xs-6 col-sm-7">
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    <li class="nav-item mr-2">
                        <div class="input-group input-group-sm mr-1" style="margin-top:4px;"><input type="text" class="form-control" placeholder="<?php echo lng('Search') ?>" aria-label="<?php echo lng('Search') ?>" aria-describedby="search-addon2" id="search-addon">
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            .theme-dark .dropzone { background: transparent; }.theme-dark .inline-actions > a > i { background: #79755e; }
            ...
            $(".js-ace-toolbar").on("click", 'button', function(e){
                ...
                if(cmdValue && cmdValue != "none") {
                    ...
                    if(editorOption == "fullscreen") {
                        ...
                        let wrapStatus = (editor.getSession().getUseWrapMode()) ? false : true;editor.getSession().setUseWrapMode(wrapStatus);
                    }
                }
            });
